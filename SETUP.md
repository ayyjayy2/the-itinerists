...
### Test offline (PWA):
```bash
npx http-server dist/ireland-stpatricks/browser -p 8080
...
2. Deploy `dist/ireland-stpatricks/browser/` to any static host:
   - **Netlify**: drag & drop the folder at netlify.com
   - **Vercel**: `npx vercel dist/ireland-stpatricks/browser`
